...
// ** Types
import { NavGroup } from 'src/shared/layouts/types'
...
import CanViewNavGroup from 'src/app/layouts/components/acl/CanViewNavGroup'

// ** Utils
import { hexToRGBA } from 'src/shared/utils/hex-to-rgba'
import { hasActiveChild } from 'src/shared/layouts/utils'
