...
// ** Types
import { NavLink, NavGroup } from 'src/shared/layouts/types'
import { Settings } from 'src/shared/context/settingsContext'

// ** Custom Components Imports
import UserIcon from 'src/app/layouts/components/UserIcon'
import Translations from 'src/app/layouts/components/Translations'
import CanViewNavLink from 'src/app/layouts/components/acl/CanViewNavLink'

// ** Util Imports
import { hexToRGBA } from 'src/shared/utils/hex-to-rgba'
import { handleURLQueries } from 'src/shared/layouts/utils'
        ...
        >
          ...
          >
            ...
            {item.secondIcon ? (
              ...
              >
                <UserIcon icon={item.secondIcon as string} />
              </ListItemIcon>
            ) : null}
          </MenuItemTextMetaWrapper>
        </MenuNavLink>
